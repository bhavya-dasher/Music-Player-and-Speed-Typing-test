...
play_btn_image = PhotoImage(file='play_img.png')
pause_btn_image = PhotoImage(file='pause_img.png')
next_btn_image = PhotoImage(file='next_img.png')
prev_btn_image = PhotoImage(file='prev_img.png')
